...
class CategoryValidate extends FormRequest {
    ...
    public function rules(): array {
        return [
            'descripcion'           => 'required|string|max:50|regex:/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s]+$/|unique:droga_categoria,descripcion,'.$this->id,
    ...
    public function messages() {
        return [
            ...
            'detalle.regex'         => 'El detalle solo puede contener letras, números, espacios y solo (, . -)',
        ];
    }
