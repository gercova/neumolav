                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control form-control-sm" id="sintomas" name="sintomas" rows="2">{{ $ap->sintomas }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control form-control-sm" id="plan" name="plan" rows="2">{{ $ap->plan }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control form-control-sm" id="tratamiento" name="tratamiento" rows="2">{{ $ap->tratamiento }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control form-control-sm" id="recomendaciones" name="recomendaciones" rows="2">{{ $ap->recomendaciones }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
