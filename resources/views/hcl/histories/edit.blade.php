                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" value="{{ $history->fecha_nacimiento->format('Y-m-d') }}" onchange="getAge(this.value);" required>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="form-group">
