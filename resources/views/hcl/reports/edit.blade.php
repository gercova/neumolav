        ...
        <div class="container-fluid">
            <div class="card card-primary">
                <div class="card-header">
                    INFORME DE {{ $hc[0]['dni'].' :: '.$hc[0]['nombres'] }}
                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <textarea class="form-control form-control-sm summernote" id="antecedentes" name="antecedentes" rows="2">{{ $rp->antecedentes }}</textarea>
                                                        </div>
                                                        <div class="col-12">
                                                            <label class="col-form-label" for="historial_enfermedad">Historial de enfermedad:</label>
                                                            <textarea class="form-control form-control-sm summernote" id="historial_enfermedad" name="historial_enfermedad" rows="2">{{ $rp->historial_enfermedad }}</textarea>
                                                        </div>
                                                        <div class="col-12">
                                                            <label class="col-form-label" for="examen_fisico">Examen físico:</label>
                                                            <textarea class="form-control form-control-sm summernote" id="examen_fisico" name="examen_fisico" rows="2">{{ $rp->examen_fisico }}</textarea>
                                                        </div>
                                                        <div class="col-12">
                                                            <label class="col-form-label" for="examen_complementario">Examen complementario:</label>
                                                            <textarea class="form-control form-control-sm summernote" id="examen_complementario" name="examen_complementario" rows="2">{{ $rp->examen_complementario }}</textarea>
                                                        </div>
                                                        <div class="col-12">
                                                            <hr>
                                                            <!--<div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <textarea class="form-control form-control-sm summernote" id="tratamiento" name="tratamiento" rows="2">{{ $rp->tratamiento }}</textarea>
                                                        </div>
                                                        <div class="col-12">
                                                            <label class="col-form-label" for="sugerencia">Sugerencia:</label>
                                                            <textarea class="form-control form-control-sm summernote" id="sugerencia" name="sugerencia" rows="2">{{ $rp->sugerencia }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
