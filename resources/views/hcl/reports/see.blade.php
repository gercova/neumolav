            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('hcl.reports.home') }}">Reportes</a></li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    @can('informe_crear')
                                        <hr>
                                        <a class="btn btn-outline btn-primary" href="{{ route('hcl.reports.add', ['id' => $hc[0]['dni']]) }}">Agregar nuevo reporte</a>
                                    @endcan
                                    <hr>
                                </div>
                                <div class="col-12">
                                    <div class="row">
                                        <div class="table-responsive">
                                            <table id="report_data" class="table table-striped table-hover">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Fecha</th>
